Make this component responsive to tablet and desktop views. The desktop view should be maintained in tablets and small screened laptops by displaying the whole component like in desktop. Also the route groups such as the dashboard when clicked should navigate to the dashboard. Make the current route display the arrow just as the image shows."use client"
